...
public class Constants {
	...
	public enum EntityStatus {Processing, Processed, Deleted, Inactive};
	...
	public static final String ADVISOR_ID_NOT_NULL="Advisor id should not be null";
	...
	public static final String FREQUENCY_QUATERLY = "quaterly";
