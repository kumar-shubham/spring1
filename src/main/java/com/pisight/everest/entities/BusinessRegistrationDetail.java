...
@Entity
@Table(name="business_registration_detail", uniqueConstraints={
		   @UniqueConstraint(columnNames={"client_id", "agency", "registration_number"})})
public class BusinessRegistrationDetail implements Serializable{

	private static final long serialVersionUID = 4504455432077041405L;
