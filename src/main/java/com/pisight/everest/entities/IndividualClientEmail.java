...
@Entity
@Table(name="individual_client_email", uniqueConstraints={
		   @UniqueConstraint(columnNames={"client_id", "email"})})
public class IndividualClientEmail implements Serializable{

	private static final long serialVersionUID = -6665999433413065111L;
