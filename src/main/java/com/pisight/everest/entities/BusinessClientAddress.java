...
@Entity
@Table(name="business_client_address_details", uniqueConstraints={
		   @UniqueConstraint(columnNames={"client_id", "address_entity_id"})})
public class BusinessClientAddress implements Serializable{

	private static final long serialVersionUID = -7679151716678514856L;
