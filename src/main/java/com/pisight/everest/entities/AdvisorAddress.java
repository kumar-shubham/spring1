...
@Entity
@Table(name="advisor_address_details", uniqueConstraints={
		   @UniqueConstraint(columnNames={"advisor_id", "address_entity_id"})})
public class AdvisorAddress implements Serializable{

	private static final long serialVersionUID = 8283868394074334506L;
