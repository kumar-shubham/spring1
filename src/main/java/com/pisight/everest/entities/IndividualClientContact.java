...
@Entity
@Table(name="individual_client_contact_details", uniqueConstraints={
		   @UniqueConstraint(columnNames={"client_id", "contact_entity_id"})})
public class IndividualClientContact implements Serializable{

	private static final long serialVersionUID = 5026976525981529323L;
