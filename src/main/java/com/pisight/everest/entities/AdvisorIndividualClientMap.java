...
@Entity
@Table(name = "advisor_individual_client_map")
public class AdvisorIndividualClientMap implements Serializable{

	private static final long serialVersionUID = -5038058705288032173L;
	...
	@ManyToOne
	@JoinColumn(name = "individual_client_id", nullable = false)
	...
	/**
	 * @param individualClient the individualClient to set
	 */
